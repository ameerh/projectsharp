...
task :populate_teams_stats => :environment do
	...
	@teams.each do |team|	
		...
		@G        = data.css("#total tbody tr")[0].css("td[3]").first.text.to_s
		...
		@G        = data.css("#total tbody tr")[1].css("td[3]").first.text.to_s
		...
		@G        = data.css("#total tbody tr")[3].css("td[3]").first.text.to_s
		...
		@G        = data.css("#plato tbody tr")[0].css("td[3]").first.text.to_s
		...
		@G        = data.css("#plato tbody tr")[1].css("td[3]").first.text.to_s
		...
		@G        = data.css("#hmvis tbody tr")[0].css("td[3]").first.text.to_s
		...
		@G        = data.css("#hmvis tbody tr")[1].css("td[3]").first.text.to_s
